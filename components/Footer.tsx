...
export default function Footer() {
    return (
        <footer className="bg-slate-200 dark:bg-slate-900 border-t border-slate-300 dark:border-slate-700 mt-24">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    {/* Column 1: Logo & Socials */}
                    <div className="space-y-4 flex flex-col items-center md:items-start">
                        <Link to="/" className="flex items-center text-slate-800 dark:text-white font-bold text-xl">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/learnthroughanalogy" target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
                                <span className="sr-only">Instagram</span>
                                <InstagramIcon />
                            </a>
                            <a href="https://www.youtube.com/@LearnThroughAnalogy" target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 tracking-wider uppercase">Quick Links</h3>
                        <ul className="mt-4 space-y-2">
                            ...
                            <li><Link to="/discussions" className="text-base text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">Discussions</Link></li>
                        </ul>
                    </div>
                    
                    {/* Column 3: Contact Info */}
                    <div>
                        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 tracking-wider uppercase">Contact Us</h3>
                ...
                <div className="mt-12 border-t border-slate-300 dark:border-slate-700 pt-8 text-center text-sm text-slate-400 dark:text-slate-500">
